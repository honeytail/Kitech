...
let ctx_01 = document.getElementById('myChart_01');	
let ctx_02 = document.getElementById('myChart_02');
let ctx_03 = document.getElementById('myChart_03');
let ctx_04 = document.getElementById('myChart_04');
let config = {
    type: 'line',
    data: {
        labels: [ // Date Objects
...
let myChart_03 = new Chart(ctx_03, config);
let myChart_04 = new Chart(ctx_04, config);
...
Calc_btn.addEventListener('click', function(e){
    ...
    push_chart(hb_model, myChart_02, data_list, 4);
    push_chart(db_model, myChart_03, data_list, 5);
    push_chart(wh_model, myChart_04, data_list, 6);

const wb_model = await tf.loadLayersModel("plugin/model/model.json");
const hb_model = await tf.loadLayersModel("plugin/model/model.json");
const db_model = await tf.loadLayersModel("plugin/model/model.json");
const wh_model = await tf.loadLayersModel("plugin/model/model.json");
const dh_model = await tf.loadLayersModel("plugin/model/model.json");
